...
execute if score #slimeTimer slimeTimer matches 400.. at @e[type=slime,tag=xygel_boss,limit=1] run summon slime ~ ~ ~ {Health:12f,Size:1,Tags:["xygel_minion"],Attributes:[{Name:generic.follow_range,Base:35},{Name:generic.attack_damage,Base:3}]}
execute if score #slimeTimer slimeTimer matches 400.. at @e[type=slime,tag=xygel_boss,limit=1] run summon slime ~ ~ ~ {Health:12f,Size:1,Tags:["xygel_minion"],Attributes:[{Name:generic.follow_range,Base:35},{Name:generic.attack_damage,Base:3}]}
execute if score #slimeTimer slimeTimer matches 400.. at @e[type=slime,tag=xygel_boss,limit=1] run summon slime ~ ~ ~ {Health:12f,Size:1,Tags:["xygel_minion"],Attributes:[{Name:generic.follow_range,Base:35},{Name:generic.attack_damage,Base:3}]}

execute if score #slimeTimer slimeTimer matches 200 at @e[type=slime,tag=xygel_boss,limit=1] run summon slime ~ ~ ~ {Health:12f,Size:1,Tags:["xygel_minion"],Attributes:[{Name:generic.follow_range,Base:35},{Name:generic.attack_damage,Base:3}]}
execute if score #slimeTimer slimeTimer matches 200 at @e[type=slime,tag=xygel_boss,limit=1] run summon slime ~ ~ ~ {Health:12f,Size:1,Tags:["xygel_minion"],Attributes:[{Name:generic.follow_range,Base:35},{Name:generic.attack_damage,Base:3}]}
execute if score #slimeTimer slimeTimer matches 200 at @e[type=slime,tag=xygel_boss,limit=1] run summon slime ~ ~ ~ {Health:12f,Size:1,Tags:["xygel_minion"],Attributes:[{Name:generic.follow_range,Base:35},{Name:generic.attack_damage,Base:3}]}
