...
# Dá as Calças
give @s minecraft:leather_leggings{display:{Name:'{"text":"Calças de Slime Primordial","color":"green","bold":true}',color:8439583, Lore:['{"text":"Indestrutível","italic":false,"color":"gray"}']},slimeboss:1b,Unbreakable:1b,HideFlags:4,Enchantments:[{id:"minecraft:protection",lvl:8s}]}
