# Xy'Gel Villager - Show Menu
# Displays the trader menu for this boss specifically

playsound minecraft:block.enchantment_table.use player @s ~ ~ ~ 1 1.2

# Set cooldown to prevent spamming (1200 ticks = 60 seconds)
scoreboard players set @s trader_cooldown 1200
